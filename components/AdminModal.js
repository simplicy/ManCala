        ...
        <StyledModalWrapper ref={modalWrapperRef}>
            ...
            <StyledModalBody>
              <form className={styles.grid} onSubmit={handleSubmit(onSubmit)}>
                <h3>Add User</h3>
                  <div>
                      <input className={styles.card} type="text" placeholder="First Last" {...register("name", {required:true})} />
                  </div>
                  <div>
                  <input className={styles.card} type="email" placeholder="example.email@cmscom.co" {...register("email", {required:true, })} />
                  </div>
